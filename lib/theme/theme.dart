...
mixin AppTheme {
  static const MaterialColor neutralColors = MaterialColor(
    0xff01BFF9, // 0% comes in here, this will be color picked if no shade is selected when defining a Color property which doesn’t require a swatch.
    <int, Color>{
  ...
  static const MaterialColor primaryColors = MaterialColor(
    0xffff5858, // 0% comes in here, this will be color picked if no shade is selected when defining a Color property which doesn’t require a swatch.
    <int, Color>{
      50: Color(0xffff5858), //10%
      100: Color(0xffff5858), //20%
      200: Color(0xffff5858), //30%
      300: Color(0xffff5858), //40%
      400: Color(0xffff5858), //50%
      500: Color(0xffff5858), //60%
      600: Color(0xffff5858), //70%
      700: Color(0xffff5858), //80%
      800: Color(0xffff5858), //90%
      900: Color(0xffff5858), //100%
    },
  );
  ...
  static final ThemeData theme1 = ThemeData(
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
            ...
            shape: RoundedRectangleBorder(
              side:
                  BorderSide(color: AppTheme.neutralColors.shade300, width: 2),
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
            ...
            shadowColor: AppTheme.neutralColors.shade50,
            elevation: 5,
            shape: RoundedRectangleBorder(
